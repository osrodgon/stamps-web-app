...
class TestUsersAPI(AbstractApiUnitTest):
    ...
    def test_get_all_users_returns_403_header_missing(self, api_client):
        response = api_client.get(self.__get_url())
    ...
    def test_get_all_users_returns_403_invalid_format(self, api_client):
    ...
    def test_get_all_users_returns_403_auth_type_not_supported(self, api_client):
    ...
    def test_get_all_users_returns_403_invalid_api_key(self, api_client):
    ...
    def test_get_all_users_returns_403_not_enough_rights(self, api_client):
    ...
    def test_get_all_users_returns_403_basic_auth_user_or_password_invalid(self, api_client):
    ...
    def test_get_all_users_returns_403_basic_auth_user_not_found(self, api_client):
    ...
    def test_post_user_returns_403_header_missing(self, api_client):
    ...
    def test_post_user_returns_403_invalid_format(self, api_client):
        self.permission(granted=False, message=Messages.Auth.invalid_format())
        response = api_client.post(self.__get_url())
    ...
    def test_post_user_returns_403_auth_type_not_supported(self, api_client):
        self.permission(granted=False, message=Messages.Auth.not_supported())
        response = api_client.post(self.__get_url())
    ...
    def test_post_user_returns_403_invalid_api_key(self, api_client, user_post_payload_ok):
        self.permission(granted=False, message=Messages.Auth.invalid_api_key())
        response = api_client.post(self.__get_url(), user_post_payload_ok, format='json')
    ...
    def test_post_user_returns_403_not_enough_rights(self, api_client, user_post_payload_ok):
        self.permission(granted=False, message=Messages.Auth.not_enough_rights())
        response = api_client.post(self.__get_url(), user_post_payload_ok, format='json')
    ...
    def test_post_user_returns_403_basic_auth_user_or_password_invalid(self, api_client):
        self.permission(granted=False, message=Messages.Auth.user_or_password_invalid())
        response = api_client.post(self.__get_url())
    ...
    def test_post_user_returns_403_basic_auth_user_not_found(self, api_client):
        self.permission(granted=False, message=Messages.Auth.user_not_found())
        response = api_client.post(self.__get_url())
    ...
    def test_get_one_user_returns_403_header_missing(self, api_client, users_table):
        user_id = users_table[0].id
        response = api_client.get(f"{self.__get_url()}{user_id}")
    ...
    def test_get_one_user_returns_403_invalid_format(self, api_client, users_table):
        self.permission(granted=False, message=Messages.Auth.invalid_format())
        user_id = users_table[0].id
        response = api_client.get(f"{self.__get_url()}{user_id}")
    ...
    def test_get_one_user_returns_403_auth_type_not_supported(self, api_client, users_table):
        self.permission(granted=False, message=Messages.Auth.not_supported())
        user_id = users_table[0].id
        response = api_client.get(f"{self.__get_url()}{user_id}")
    ...
    def test_get_one_user_returns_403_invalid_api_key(self, api_client, users_table):
        self.permission(granted=False, message=Messages.Auth.invalid_api_key())
        user_id = users_table[0].id
        response = api_client.get(f"{self.__get_url()}{user_id}")
    ...
    def test_get_one_user_returns_403_not_enough_rights(self, api_client, users_table):
        self.permission(granted=False, message=Messages.Auth.not_enough_rights())
        user_id = users_table[0].id
        response = api_client.get(f"{self.__get_url()}{user_id}")
    ...
    def test_get_one_user_returns_403_basic_auth_user_or_password_invalid(self, api_client, users_table):
        self.permission(granted=False, message=Messages.Auth.user_or_password_invalid())
        user_id = users_table[0].id
        response = api_client.get(f"{self.__get_url()}{user_id}")
    ...
    def test_get_one_user_returns_403_basic_auth_user_not_found(self, api_client, users_table):
        self.permission(granted=False, message=Messages.Auth.user_not_found())
        user_id = users_table[0].id
        response = api_client.get(f"{self.__get_url()}{user_id}")
    ...
    def test_put_user_returns_403_header_missing(self, api_client, users_table):
        user_id = users_table[0].id
        response = api_client.put(f"{self.__get_url()}{user_id}")
    ...
    def test_put_user_returns_403_invalid_format(self, api_client, users_table):
        self.permission(granted=False, message=Messages.Auth.invalid_format())
        user_id = users_table[0].id
        response = api_client.put(f"{self.__get_url()}{user_id}")
    ...
    def test_put_user_returns_403_auth_type_not_supported(self, api_client, users_table):
        self.permission(granted=False, message=Messages.Auth.not_supported())
        user_id = users_table[0].id
        response = api_client.put(f"{self.__get_url()}{user_id}")
    ...
    def test_put_user_returns_403_invalid_api_key(self, api_client, users_table, user_put_payload_ok):
        self.permission(granted=False, message=Messages.Auth.invalid_api_key())
        user_id = users_table[0].id
        response = api_client.put(f"{self.__get_url()}{user_id}", user_put_payload_ok, format='json')
    ...
    def test_put_user_returns_403_not_enough_rights(self, api_client, users_table, user_put_payload_ok):
        self.permission(granted=False, message=Messages.Auth.not_enough_rights())
        user_id = users_table[0].id
        response = api_client.put(f"{self.__get_url()}{user_id}", user_put_payload_ok, format='json')
    ...
    def test_put_user_returns_403_basic_auth_user_or_password_invalid(self, api_client, users_table):
        self.permission(granted=False, message=Messages.Auth.user_or_password_invalid())
        user_id = users_table[0].id
        response = api_client.put(f"{self.__get_url()}{user_id}")
    ...
    def test_put_user_returns_403_basic_auth_user_not_found(self, api_client, users_table):
        self.permission(granted=False, message=Messages.Auth.user_not_found())
        user_id = users_table[0].id
        response = api_client.put(f"{self.__get_url()}{user_id}")
    ...
    def test_delete_user_returns_403_header_missing(self, api_client, users_table):
        user_id = users_table[0].id
        response = api_client.delete(f"{self.__get_url()}{user_id}")
    ...
    def test_delete_user_returns_403_invalid_format(self, api_client, users_table):
        self.permission(granted=False, message=Messages.Auth.invalid_format())
        user_id = users_table[0].id
        response = api_client.delete(f"{self.__get_url()}{user_id}")
    ...
    def test_delete_user_returns_403_auth_type_not_supported(self, api_client, users_table):
        self.permission(granted=False, message=Messages.Auth.not_supported())
        user_id = users_table[0].id
        response = api_client.delete(f"{self.__get_url()}{user_id}")
    ...
    def test_delete_user_returns_403_invalid_api_key(self, api_client, users_table):
        self.permission(granted=False, message=Messages.Auth.invalid_api_key())
        user_id = users_table[0].id
        response = api_client.delete(f"{self.__get_url()}{user_id}")
    ...
    def test_delete_user_returns_403_not_enough_rights(self, api_client, users_table):
        self.permission(granted=False, message=Messages.Auth.not_enough_rights())
        user_id = users_table[0].id
        response = api_client.delete(f"{self.__get_url()}{user_id}")
    ...
    def test_delete_user_returns_403_basic_auth_user_or_password_invalid(self, api_client, users_table):
        self.permission(granted=False, message=Messages.Auth.user_or_password_invalid())
        user_id = users_table[0].id
        response = api_client.delete(f"{self.__get_url()}{user_id}")
    ...
    def test_delete_user_returns_403_basic_auth_user_not_found(self, api_client, users_table):
        self.permission(granted=False, message=Messages.Auth.user_not_found())
        user_id = users_table[0].id
        response = api_client.delete(f"{self.__get_url()}{user_id}")

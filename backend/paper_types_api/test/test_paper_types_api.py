...
class TestPaperTypesAPI(AbstractApiUnitTest):
    def test_get_all_paper_types_returns_200_ok_data(self, api_client, paper_types_table):
        ...
        assert len(response.json()['data']) == len(paper_types_table)
    ...
    def test_post_paper_type_returns_400_bad_request_invalid_payload_missing_name(self, api_client):
        self.permission(granted=True)
    ...
    def test_post_paper_type_returns_400_bad_request_invalid_payload_field_not_allowed(self, api_client, paper_type_post_payload_ok):
        self.permission(granted=True)
        paper_type_post_payload_ok['invalid_field'] = 'value'
        response = api_client.post(self.__get_url(), paper_type_post_payload_ok)
    ...
    def test_post_paper_type_returns_400_bad_request_duplicate_name(self, api_client, paper_types_table):
        self.permission(granted=True)
        response = api_client.post(self.__get_url(), {'name': paper_types_table[0].name})
        
        assert response.json()['success'] == False
        assert response.json()['message'] == Messages.failed()
        assert response.json()['data'] == None
        assert response.json()['errors'][0]['field'] == "name"
        assert response.json()['errors'][0]['message'] == Messages.Post.already_exists("paper type", 'name')  
    ...
    def test_post_paper_type_returns_403_invalid_api_key(self, api_client):
        self.permission(granted=False, message=Messages.Auth.invalid_api_key())
        response = api_client.get(self.__get_url())
    ...
    def test_post_paper_type_returns_403_not_enough_rights(self, api_client):
        self.permission(granted=False, message=Messages.Auth.not_enough_rights())
        response = api_client.get(self.__get_url())
    ...
    def test_get_one_paper_type_returns_200_ok_data(self, api_client, paper_types_table):
        self.permission(granted=True)
        id = str(paper_types_table[0].id)
    ...
    def test_get_one_paper_type_returns_403_header_missing(self, api_client):
        response = api_client.get(self.__get_url())
    ...
    def test_get_one_paper_type_returns_403_invalid_format(self, api_client):
        self.permission(granted=False, message=Messages.Auth.invalid_format())
        response = api_client.get(self.__get_url())
    ...
    def test_get_one_paper_type_returns_403_auth_type_not_supported(self, api_client):
        self.permission(granted=False, message=Messages.Auth.not_supported())
        response = api_client.get(self.__get_url())
    ...
    def test_get_one_paper_type_returns_403_invalid_api_key(self, api_client):
        self.permission(granted=False, message=Messages.Auth.invalid_api_key())
        response = api_client.get(self.__get_url())
    ...
    def test_get_one_paper_type_returns_403_not_enough_rights(self, api_client):
        self.permission(granted=False, message=Messages.Auth.not_enough_rights())
        response = api_client.get(self.__get_url())
    ...
    def test_get_one_paper_type_returns_403_basic_auth_user_or_password_invalid(self, api_client):
        self.permission(granted=False, message=Messages.Auth.user_or_password_invalid())
        response = api_client.get(self.__get_url())
    ...
    def test_get_one_paper_type_returns_403_basic_auth_user_not_found(self, api_client):
        self.permission(granted=False, message=Messages.Auth.user_not_found())
        response = api_client.get(self.__get_url())
    ...
    def test_put_paper_type_returns_200_ok(self, api_client, paper_types_table,  paper_type_put_payload_ok):
        self.permission(granted=True)
        id = str(paper_types_table[0].id)
        response = api_client.put(self.__get_url() + id, paper_type_put_payload_ok)
    ...
    def test_put_paper_type_returns_400_bad_request_duplicate_name(self, api_client, paper_types_table):
        self.permission(granted=True)
        id = str(paper_types_table[0].id)
        response = api_client.put(self.__get_url() + id, {'name': paper_types_table[1].name})
        
        assert response.json()['success'] == False
        assert response.json()['message'] == Messages.failed()
        assert response.json()['data'] == None
        assert response.json()['errors'][0]['field'] == "name"
        assert response.json()['errors'][0]['message'] == Messages.Put.already_exists("paper type", paper_types_table[1].name) 
        assert response.json()['errors'][0]['code'] == Messages.Code.unique()
        assert response.status_code == status.HTTP_400_BAD_REQUEST
        
    def test_put_paper_type_returns_403_header_missing(self, api_client):
        response = api_client.get(self.__get_url())
    ...
    def test_put_paper_type_returns_403_invalid_format(self, api_client):
        self.permission(granted=False, message=Messages.Auth.invalid_format())
        response = api_client.get(self.__get_url())
    ...
    def test_put_paper_type_returns_403_auth_type_not_supported(self, api_client):
        self.permission(granted=False, message=Messages.Auth.not_supported())
        response = api_client.get(self.__get_url())
    ...
    def test_put_paper_type_returns_403_invalid_api_key(self, api_client):
        self.permission(granted=False, message=Messages.Auth.invalid_api_key())
        response = api_client.get(self.__get_url())
    ...
    def test_put_paper_type_returns_403_not_enough_rights(self, api_client):
        self.permission(granted=False, message=Messages.Auth.not_enough_rights())
        response = api_client.get(self.__get_url())
    ...
    def test_put_paper_type_returns_403_basic_auth_user_or_password_invalid(self, api_client):
        self.permission(granted=False, message=Messages.Auth.user_or_password_invalid())
        response = api_client.get(self.__get_url())
    ...
    def test_put_paper_type_returns_403_basic_auth_user_not_found(self, api_client):
        self.permission(granted=False, message=Messages.Auth.user_not_found())
        response = api_client.get(self.__get_url())
    ...
    def test_put_paper_type_returns_404_not_found(self, api_client):
        self.permission(granted=True)
    ...
    def test_delete_paper_type_returns_403_header_missing(self, api_client):
        response = api_client.get(self.__get_url())
    ...
    def test_delete_paper_type_returns_403_invalid_format(self, api_client):
        self.permission(granted=False, message=Messages.Auth.invalid_format())
        response = api_client.get(self.__get_url())
    ...
    def test_delete_paper_type_returns_403_auth_type_not_supported(self, api_client):
        self.permission(granted=False, message=Messages.Auth.not_supported())
        response = api_client.get(self.__get_url())
    ...
    def test_delete_paper_type_returns_403_invalid_api_key(self, api_client):
        self.permission(granted=False, message=Messages.Auth.invalid_api_key())
        response = api_client.get(self.__get_url())
    ...
    def test_delete_paper_type_returns_403_not_enough_rights(self, api_client):
        self.permission(granted=False, message=Messages.Auth.not_enough_rights())
        response = api_client.get(self.__get_url())
    ...
    def test_delete_paper_type_returns_403_basic_auth_user_or_password_invalid(self, api_client):
        self.permission(granted=False, message=Messages.Auth.user_or_password_invalid())
        response = api_client.get(self.__get_url())
    ...
    def test_delete_paper_type_returns_403_basic_auth_user_not_found(self, api_client):
        self.permission(granted=False, message=Messages.Auth.user_not_found())
        response = api_client.get(self.__get_url())

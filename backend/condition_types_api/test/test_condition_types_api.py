...
class TestConditionTypesAPI(AbstractApiUnitTest):
    ...
    def test_get_all_condition_types_returns_403_invalid_key(self, api_client):
    ...
    def test_get_all_condition_types_returns_403_invalid_user(self, api_client):
    ...
    def test_post_condition_type_returns_400_invalid_field(self, api_client, condition_type_post_payload_ok):
        self.permission(granted=True)
    ...
    def test_post_condition_type_returns_403_invalid_key(self, api_client, condition_type_post_payload_ok):
        self.permission(granted=False, message=Messages.APIKey.invalid_key())
        response = api_client.post(self.__get_url(), condition_type_post_payload_ok, format='json')
    ...
    def test_post_condition_type_returns_403_invalid_user(self, api_client, condition_type_post_payload_ok):
        self.permission(granted=False, message=Messages.APIKey.invalid_user())
        response = api_client.post(self.__get_url(), condition_type_post_payload_ok, format='json')
    ...
    def test_get_one_condition_type_returns_200_ok(self, api_client, condition_types_table):
        self.permission(granted=True)
    ...
    def test_get_one_condition_type_returns_403_invalid_key(self, api_client, condition_types_table):
        self.permission(granted=False, message=Messages.APIKey.invalid_key())
        condition_type_id = condition_types_table[0].id
        response = api_client.get(f"{self.__get_url()}{condition_type_id}")
    ...
    def test_get_one_condition_type_returns_403_invalid_user(self, api_client, condition_types_table):
        self.permission(granted=False, message=Messages.APIKey.invalid_user())
        condition_type_id = condition_types_table[0].id
        response = api_client.get(f"{self.__get_url()}{condition_type_id}")
    ...
    def test_delete_condition_type_returns_403_invalid_key(self, api_client, condition_types_table):
        self.permission(granted=False, message=Messages.APIKey.invalid_key())
        condition_type_id = condition_types_table[0].id
        response = api_client.delete(f"{self.__get_url()}{condition_type_id}")
    ...
    def test_delete_condition_type_returns_403_invalid_user(self, api_client, condition_types_table):
        self.permission(granted=False, message=Messages.APIKey.invalid_user())
        condition_type_id = condition_types_table[0].id
        response = api_client.delete(f"{self.__get_url()}{condition_type_id}")
